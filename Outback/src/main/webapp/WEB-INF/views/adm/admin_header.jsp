...
=======
>>>>>>> branch 'SeungHyuk' of https://github.com/korin112/humakase.git
...
>>>>>>> branch 'SeungHyuk' of https://github.com/korin112/humakase.git
	...
	<div>
		<div>
			<a href="/outback/home" class="btn btn-outline-light adm_go_home">
				<svg class="bi me-2" width="24" height="24"><use xlink:href="#house-door"></use></svg>
				<span class="adm_nav_tt">홈페이지로 이동</span>
			</a>
		</div>
		<div class="adm_user">
			<strong>${userid}님</strong>
			<a href="/outback/logout" class="text-white text-decoration-none" aria-expanded="false">
				로그아웃
			</a>
		</div>
	</div>
