...
public class Board { 
	...
	public Board(int board_id, String title, String content, String writer, Date created, Date updated, Date vdate,
			int spot_code, int menu_code, String menu_name, String spot_name) {
	...
	public String toString() {
		return "Board [board_id=" + board_id + ", title=" + title + ", content=" + content + ", writer=" + writer
				+ ", created=" + created + ", updated=" + updated + ", vdate=" + vdate + ", spot_code=" + spot_code
				+ ", menu_code=" + menu_code + ", spot_name=" + spot_name + ", menu_name=" + menu_name + "]";
	}
